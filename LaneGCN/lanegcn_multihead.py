...
class Net(nn.Module):
    ...
    def __init__(self, config, idx):
        ...
        self.pred_net_LCL = PredNet(config)
        self.pred_net_LCR = PredNet(config)
        self.maneuver_idx = idx
...
def get_model():
    ...
    return config, ArgoDataset, collate_fn, net, loss, post_process, Optimizer
